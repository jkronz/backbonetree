(function() {
  ...
  compactTree.CompactTree = (function(_super) {
    ...
    CompactTree.prototype.render = function() {
      this.root = new compactTree.CompactTreeNode({
        node: this.tree,
        parent: null,
        nameField: this.nameField,
        treeView: this
      });
      this.childViews.push(this.root);
      this.root.render();
      this.$el.html(this.template());
      this.refreshViewport(null);
      return this;
    };
    ...
    CompactTree.prototype.refreshViewport = function(currentView) {
      ...
      if (this.currentView != null) {
        ...
        this.$('.tree-items').html(this.root.el);
        this.root.delegateEvents();
        return this.$('.back').hide();
      }
    };
